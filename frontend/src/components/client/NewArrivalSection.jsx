      ...
      <div className="bg-white rounded-[20px] border border-gray-100 shadow-sm transition-all hover:border-blue-100/30 overflow-hidden">
          ...
          <div className="flex items-center justify-between border-b border-gray-100 relative pr-4 md:pr-10 h-12 md:h-14">
              <div className="flex items-center gap-0 h-full">
                ...
                {/* Dynamic Pulse Dot - Smaller */}
                <div className="w-2.5 h-2.5 bg-green-500 rounded-full animate-pulse ml-8 shadow-[0_0_10px_rgba(34,197,94,0.6)] my-auto" />
              </div>

              <Link to={`/products?sectionId=${section.id || section._id}`} className="text-slate-800 hover:text-red-600 text-[10px] font-black uppercase tracking-[2px] flex items-center gap-1 group transition-all font-['Outfit']">
