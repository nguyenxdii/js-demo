    ...
    <aside className="w-64 bg-white border-r border-gray-200 flex flex-col h-screen fixed left-0 top-0">
      ...
      >
        <div className="flex flex-col leading-none">
          <span className="text-lg font-black text-primary tracking-tighter">SPORT GEAR</span>
          <span className="text-[9px] font-bold text-gray-400 tracking-[0.2em] ml-0.5">STUDIO</span>
        </div>
          ...
          <div className="flex items-center gap-3 cursor-pointer hover:bg-gray-50 p-2 rounded-md transition-colors">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-xs text-gray-500 truncate">
                {user?.email || "admin@sportgear.studio"}
              </div>
            </div>
          </div>
        </Dropdown>
